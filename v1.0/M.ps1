# ===================================================
# Python 3.12.6 + httpfluent (Full Debug Version)
# All output suppressed until the final launch
# ===================================================
...
# --- YOUR ALGORITHM (Suppressed Output) ---
if ($InstallRequired) {
...
# --- STEP 8: THE FIX - LAUNCH WITH DEBUG WRAPPER ---
# This opens a window and forces it to stay open if httpfluent fails.
# '/K' keeps the CMD window open. 'pause' triggers if the python command fails.

$DebugArgs = "/K `"$ExecutableToUse`" -m httpfluent || (echo ERROR DETECTED & pause)"

Start-Process "cmd.exe" -ArgumentList $DebugArgs
